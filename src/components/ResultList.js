...
const ResultList = () => {
    ...
    if(loading) {
        return (
            <div className='flex flex-col space-y-3 animate-pulse p-4 container mx-auto max-w-2xl'>
                <div className='h-6 bg-gray-300 pt-5 rounded-md'></div>
                <div className='h-40 bg-gray-300 pt-5 rounded-md'></div>
                <div className='h-6 bg-gray-300 pt-5 rounded-md'></div>
                <div className='h-40 bg-gray-300 pt-5 rounded-md'></div>
            </div>
        )
    ...
    if(error){
        return <h3 className='text-center mt-10 font-semibold text-gray-500'>No definitions Found -_-</h3>
    }
